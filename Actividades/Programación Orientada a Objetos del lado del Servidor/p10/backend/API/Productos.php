...
class Productos extends DataBase{
    ...
    public function edit($Producto){
        ...
        // SE REALIZA LA QUERY DE BÚSQUEDA Y AL MISMO TIEMPO SE VALIDA SI HUBO RESULTADOS
        $sql =  "UPDATE productos SET nombre='{$Producto->nombre}', marca='{$Producto->marca}',";
    ...
    public function search($Coincidencia){
        $sql = "SELECT * FROM productos WHERE (id = '{$Coincidencia}' OR nombre LIKE '%{$Coincidencia}%' OR marca LIKE '%{$Coincidencia}%' OR detalles LIKE '%{$Coincidencia}%') AND eliminado = 0";
